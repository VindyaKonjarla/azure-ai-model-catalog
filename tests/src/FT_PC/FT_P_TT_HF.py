...
def create_and_run_azure_ml_pipeline(
    ...
    def create_pipeline():
        translation_pipeline = pipeline_component_func(
            ...
            evaluation_config=Input(type="uri_file", path="./wmt16-en-ro-dataset/translation-config.json"),
...
if __name__ == "__main__":
    ...
    print ("Running for Text Translation HF")
    ...
    experiment_name = "hf-text-translation-"+ test_model_name
    ...
    try:
        ...
        sys.exit(1)
    print("Finetuned and the registered model for Text-translation HF successfully")
